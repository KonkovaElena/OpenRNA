...
const DEFAULT_ROLE_PERMISSIONS: Readonly<Record<Role, readonly RbacAction[]>> = {
  SYSTEM: ["CREATE_CASE", "REGISTER_SAMPLE", "REQUEST_WORKFLOW", "APPROVE_REVIEW", "VIEW_CASE", "ADMIN_OPERATIONS"],
  ADMIN:  ["CREATE_CASE", "REGISTER_SAMPLE", "REQUEST_WORKFLOW", "APPROVE_REVIEW", "VIEW_CASE", "ADMIN_OPERATIONS"],
