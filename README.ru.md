...
- Перепроверено 2026-04-20: 498 тестов (22 набора), 94.93% покрытия по строкам, 83.46% по ветвлениям, 94.59% по функциям, `npm audit --omit=dev --audit-level=high` - без уязвимостей.
...
Базовый формальный срез доказательности: [`docs/archive/FORMAL_EVIDENCE_REGISTER_2026-04-20.md`](docs/archive/FORMAL_EVIDENCE_REGISTER_2026-04-20.md).
...
| Манифестации электронных подписей и двухэтапная release-церемония | Реализованы частично, но не доведены до identity-bound Part 11 уровня |
