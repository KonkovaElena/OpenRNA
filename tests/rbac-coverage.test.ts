...
describe("RBAC deny-by-default coverage", () => {
  ...
  const postRoutes = [
    ...
    { path: "/api/cases/c1/qa-releases", body: {}, status: 403, label: "POST /api/cases/:caseId/qa-releases" },
  ...
  const getRoutes = [
    ...
    { path: "/api/cases/c1/qa-releases", status: 403, label: "GET qa-releases" },
    { path: "/api/cases/c1/qa-releases/q1", status: 403, label: "GET qa-releases/:qaReleaseId" },
